const MIR_F1_FRM_darkBackground = '#D9D9D9'

const MIR_F1_FRM_lineupOptions = ['ECHL L', 'ECHL R', 'BAN L', 'BAN R', 'STAG L', 'STAG R', 'INDIV'];
const MIR_F1_FRM_takeoffOptions = ['VFR 1', 'VFR 2', 'IFR 1', 'IFR 2', 'IFR 3'];
const MIR_F1_FRM_formationOptions = ['ECHL L', 'ECHL R', 'F4 L', 'F4 R', 'FW L', 'FW R', 'WEDGE L', 'WEDGE R', 'BTL L', 'BTL R', 'BTL 4 L', 'BTL 4 R', 'CARD L', 'CARD R', 'FL 4 L', 'FL 4 R'];
const MIR_F1_FRM_recoveryOptions = ['SKY CLR', 'CLD BRK', 'IFR 1', 'IFR 2', 'IFR 3'];
const MIR_F1_FRM_landingOptions = ['INDIV', 'FORM'];
const MIR_F1_FRM_confOptions = ['6A', '6F', '6B', '6K', '6+8A', '6+8F', '6+8B', '6+8K', '6+8+8F', '6+8+14A', '6+8+14F', '6+8B+4x250 kg'];
const MIR_F1_FRM_targetingOptions = ['L/S/H', 'T/S/L', 'L/X/H', 'T/X/L'];
const MIR_F1_FRM_sortingOptions = ['L/S/H', 'T/S/L', 'T/S/H', 'L/S/L'];
const MIR_F1_FRM_riskLevelOptions = ['LOW', 'MEDIUM', 'HIGH'];
const MIR_F1_FRM_yesNoOptions = ['Y', 'N'];
const MIR_F1_FRM_wcsOptions = ['HOLD', 'TIGHT', 'FREE'];

const MIR_F1_FRM_reactionCanvasPath = "M2 0 2 25 27 25 27 0ZM62 45A1 1 0 0032 45 1 1 0 0062 45M30 70A1 1 0 000 70 1 1 0 0030 70M27 25 36 35M-7 31C-9 31-10 32-10 34L-10 48C-10 51-9 51-7 51M2 31C4 31 5 32 5 34L5 48C5 50 4 51 2 51M8 43 8 45 14 45 14 43ZM10 42 12 42 12 40 14 40 14 38 12 38 12 36 10 36 10 38 8 38 8 40 10 40Z";
const MIR_F1_FRM_racetrackPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM35 18 33 20 35 22 37 20 35 18ZM35 19 34 20 35 21 36 20 35 19Z";
const MIR_F1_FRM_racetrackRightHandPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM5 18 3 20 5 22 7 20 5 18ZM5 19 4 20 5 21 6 20 5 19Z";
const MIR_F1_FRM_racetrack1ShipPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM35 18 33 20 35 22 37 20 35 18M35 25 33 29 37 29ZM35 19 34 20 35 21 36 20 35 19Z";
const MIR_F1_FRM_racetrack1ShipRightHandPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM5 18 3 20 5 22 7 20 5 18M5 25 3 29 7 29ZM5 19 4 20 5 21 6 20 5 19Z";
const MIR_F1_FRM_racetrack11ShipPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM35 18 33 20 35 22 37 20 35 18M35 25 33 29 37 29ZM35 19 34 20 35 21 36 20 35 19M5 60 3 56 7 56Z";
const MIR_F1_FRM_racetrack11ShipRightHandPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM5 18 3 20 5 22 7 20 5 18M5 25 3 29 7 29ZM5 19 4 20 5 21 6 20 5 19M35 60 33 56 37 56Z";
const MIR_F1_FRM_racetrack2ShipPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM35 18 33 20 35 22 37 20 35 18M32 25 30 29 34 29ZM38 25 36 29 40 29ZM35 19 34 20 35 21 36 20 35 19";
const MIR_F1_FRM_racetrack2ShipRightHandPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM5 18 3 20 5 22 7 20 5 18M2 25 0 29 4 29ZM8 25 6 29 10 29ZM5 19 4 20 5 21 6 20 5 19";
const MIR_F1_FRM_racetrack22ShipPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM35 18 33 20 35 22 37 20 35 18M32 25 30 29 34 29ZM38 25 36 29 40 29ZM35 19 34 20 35 21 36 20 35 19M8 60 6 56 10 56ZM2 60 0 56 4 56Z";
const MIR_F1_FRM_racetrack22ShipRightHandPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM5 18 3 20 5 22 7 20 5 18M2 25 0 29 4 29ZM8 25 6 29 10 29ZM5 19 4 20 5 21 6 20 5 19M38 60 36 56 40 56ZM32 60 30 56 34 56Z";
const MIR_F1_FRM_racetrack4ShipPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM35 18 33 20 35 22 37 20 35 18M32 25 30 29 34 29ZM28 29 30 33 26 33ZM38 25 36 29 40 29ZM42 29 40 33 44 33ZM35 19 34 20 35 21 36 20 35 19";
const MIR_F1_FRM_racetrack4ShipRightHandPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM5 18 3 20 5 22 7 20 5 18M2 25 0 29 4 29ZM-2 29 0 33-4 33ZM9 25 7 29 11 29ZM13 29 11 33 15 33ZM5 19 4 20 5 21 6 20 5 19";
const MIR_F1_FRM_racetrack4ShipBoxPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM35 18 33 20 35 22 37 20 35 18M32 25 30 29 34 29ZM32 31 34 35 30 35ZM38 25 36 29 40 29ZM38 31 36 35 40 35ZM35 19 34 20 35 21 36 20 35 19";
const MIR_F1_FRM_racetrack4ShipBoxRightHandPath = "M5 20A1 1 0 0135 20L35 65A1 1 0 015 65ZM5 18 3 20 5 22 7 20 5 18M2 25 0 29 4 29ZM2 31 4 35 0 35ZM9 25 7 29 11 29ZM9 31 7 35 11 35ZM5 19 4 20 5 21 6 20 5 19";

const MIR_F1_FRM_racetrackPathList = [
    MIR_F1_FRM_racetrackPath, MIR_F1_FRM_racetrack1ShipPath, MIR_F1_FRM_racetrack11ShipPath, MIR_F1_FRM_racetrack2ShipPath, MIR_F1_FRM_racetrack22ShipPath, MIR_F1_FRM_racetrack4ShipPath, MIR_F1_FRM_racetrack4ShipBoxPath,
    MIR_F1_FRM_racetrackRightHandPath, MIR_F1_FRM_racetrack1ShipRightHandPath, MIR_F1_FRM_racetrack11ShipRightHandPath, MIR_F1_FRM_racetrack2ShipRightHandPath, MIR_F1_FRM_racetrack22ShipRightHandPath, MIR_F1_FRM_racetrack4ShipRightHandPath, MIR_F1_FRM_racetrack4ShipBoxRightHandPath
];

const MIR_F1_FRM_1 = {
    id: 'MIR-F1-FRM-page-1',
    _name: 'Mirage F1 FRM kneeboard page 1',
    rows: 44,
    columns: 19,
    // ----------------================ textCells ================----------------
    textCells: [
        // Row 1
        {
            ...
            backgroundColor: MIR_F1_FRM_darkBackground
        },
        {
            _name: 'Mission name',
    ...
    textFieldCells: [
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-1', 'pilot-1-radar-channel'],
            ],
            position: [2, 3, 7, 8],
            borderWidths: [1, 1, 1, 1],
            textAlign: 'center',
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-1', 'pilot-2-radar-channel'],
            ],
            position: [3, 4, 7, 8],
            borderWidths: [1, 1, 1, 1],
            textAlign: 'center'
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-1', 'pilot-3-radar-channel'],
            ],
            position: [4, 5, 7, 8],
            borderWidths: [1, 1, 1, 1],
            textAlign: 'center',
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-1', 'pilot-4-radar-channel'],
            ],
            position: [5, 6, 7, 8],
            borderWidths: [1, 1, 1, 1],
            textAlign: 'center'
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-1', 'pilot-5-radar-channel'],
            ],
            position: [6, 7, 7, 8],
            borderWidths: [1, 1, 1, 1],
            textAlign: 'center',
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-1', 'pilot-6-radar-channel'],
            ],
            position: [7, 8, 7, 8],
            borderWidths: [1, 1, 2, 1],
            textAlign: 'center'
        ...
        // Row 13-14
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'bas-altitude'],
            ],
            position: [12, 14, 1, 2],
            borderWidths: [1, 1, 2, 1],
            textAlign: 'center',
        ...
        },
        {
            ...
            options: MIR_F1_FRM_lineupOptions,
            dropdownSide: 'left',
            position: [16, 17, 7, 9],
            borderWidths: [0, 2, 0, 2],
            padding: 2
        ...
        },
        {
            ...
            options: MIR_F1_FRM_takeoffOptions,
            dropdownSide: 'left',
            position: [18, 19, 7, 9],
            borderWidths: [0, 2, 0, 2],
            padding: 2
        ...
        },
        {
            ...
            options: MIR_F1_FRM_formationOptions,
            selectColumns: 2,
            dropdownSide: 'left',
            position: [20, 21, 7, 9],
            borderWidths: [0, 2, 0, 2],
        ...
        },
        {
            ...
            options: MIR_F1_FRM_recoveryOptions,
            dropdownSide: 'left',
            position: [22, 23, 7, 9],
            borderWidths: [0, 2, 0, 2],
            textAlign: 'right',
        ...
        },
        {
            ...
            options: MIR_F1_FRM_landingOptions,
            dropdownSide: 'left',
            position: [24, 25, 7, 9],
        ...
        // Row 27
        {
            ...
            options: MIR_F1_FRM_confOptions,
            dropdownSide: 'left',
            linkedFields: [
                'perf-data-jx',
                'perf-data-rto',
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-11-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-12-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-13-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-14-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-15-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-16-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-17-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-18-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-19-name'],
            ],
        ...
        },
        {
            ...
            linkedFields: [
                ['MIR-F1-FRM-page-2', 'nav-point-20-name'],
            ],
...
const MIR_F1_FRM_2 = {
    id: 'MIR-F1-FRM-page-2',
    _name: 'Mirage F1 FRM kneeboard page 2',
    rows: 44,
    columns: 19,
    // ----------------================ textCells ================----------------
    textCells: [
        ...
        // Row 3 - 9
        {
            ...
            path: MIR_F1_FRM_reactionCanvasPath,
            position: [2, 9, 11, 15],
            borderWidths: [1, 1, 1, 2],
        },
        {
    ...
    textFieldCells: [
            ...
            fields: [
                {
                    textFieldCells: [
                        // Row 3
                        {
                            ...
                            options: MIR_F1_FRM_targetingOptions,
                            position: [2, 3, 1, 3],
                            borderWidths: [1, 1, 1, 1],
                            textAlign: 'center',
                            backgroundColor: MIR_F1_FRM_darkBackground
            ...
            fields: [
                {
                    textFieldCells: [
                        // Row 3
                        {
                            ...
                            options: MIR_F1_FRM_sortingOptions,
                            position: [2, 3, 3, 5],
                            borderWidths: [1, 1, 1, 1],
                            textAlign: 'center',
                            backgroundColor: MIR_F1_FRM_darkBackground
        ...
        // Row 10 - 15
        {
            ...
            options: MIR_F1_FRM_racetrackPathList,
            selectColumns: 7,
            position: [9, 15, 0, 2],
            borderWidths: [1, 0, 2, 2],
            default: 0,
        ...
        // Row 17-19
        {
            ...
            options: MIR_F1_FRM_riskLevelOptions,
            linkedFields: [
                'risk-level-flow',
        ...
        },
        {
            ...
            options: MIR_F1_FRM_yesNoOptions,
            position: [34, 35, 6, 7],
            borderWidths: [2, 1, 1, 0],
            textAlign: 'center',
        },
        ...
        // Row 38-40
        {
            ...
            _description: 'BAS altitude field',
            linkedFields: [
                ['MIR-F1-FRM-page-1', 'bas-altitude'],
            ],
            position: [37, 39, 6, 7],
            borderWidths: [1, 1, 2, 1],
            textAlign: 'center',
...
const MIR_F1_FRM = {
    id: 'MIR_F1_FRM',
    name: 'Mirage F1 FRM',
    pages: [MIR_F1_FRM_1, MIR_F1_FRM_2]
};